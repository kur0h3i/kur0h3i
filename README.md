...
# 👋 Hi, I'm Pedro Pérez Montero

### Software Engineer | Linux Enthusiast | Cybersecurity Specialist

<p>
Passionate software engineer with deep expertise in <strong>Linux systems administration</strong> and <strong>cybersecurity</strong>. I thrive on building secure, scalable infrastructures and hardening servers. My love for open-source and command-line efficiency drives me to create robust solutions.
</p>
...
- 🐧 **Linux Power User:** Daily Arch Linux user with extensive server administration experience
- 🔒 **Security Focus:** Penetration testing, server hardening, and network security
- 🖥️ **Infrastructure:** Building and maintaining secure, high-performance server environments
- 💻 **Full-Stack Developer:** Creating scalable web applications with modern frameworks
- ⚙️ **Automation Enthusiast:** Bash scripting and system optimization
- 🚗 **Off The Clock:** Car enthusiast and automotive culture fan
- 🌱 **Currently Learning:** Advanced security practices and cloud architecture
- 💬 **Ask Me About:** Linux, server security, pentesting, or anything sysadmin-related
...
**System Management**
- System configuration, optimization, and performance tuning
- User management, permissions, and access control
- Service deployment, monitoring, and troubleshooting
- Backup solutions and disaster recovery planning

**🛡️ Server Hardening & Security**
...
- Advanced Bash scripting for task automation
...
- DNS and network services setup
...
![SQLMap](https://img.shields.io/badge/SQLMap-CC6699?style=for-the-badge&logoColor=white)
...
- **🔍 Penetration Testing:** Web applications, network infrastructure, and system vulnerability assessment
- **🛡️ Network Security:** IDS/IPS configuration, traffic analysis, network hardening
- **🔎 Vulnerability Assessment:** Automated scanning (Nessus, Nmap), manual testing, exploit development
